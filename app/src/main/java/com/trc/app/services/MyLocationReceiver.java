...
public class MyLocationReceiver extends BroadcastReceiver {
    ...
    */
    ...
    public MyLocationReceiver(Context context) {
        this.mSnackBar = Snackbar.make(((Activity)context).findViewById(android.R.id.content), context.getString(R.string.error_msg_location), Snackbar.LENGTH_INDEFINITE);
    }
